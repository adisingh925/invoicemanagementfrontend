...
function NotecardData(props) {
  return (
    <div
      key={props.cardData.gym_id}
      ...
      style={{ height: "250px" }}
    >
      <Link to={props.cardData.gym_id + "/members"}>
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          {props.cardData.gym_name}
        </h5>
      </Link>
      <p className="mb-1 font-normal text-gray-700 dark:text-gray-400">
        <span className="font-semibold">Address : </span>{" "}
        {props.cardData.gym_address}
      </p>
      <p className="mb-1 font-normal text-gray-700 dark:text-gray-400">
        <span className="font-semibold">Phone Number : </span>{" "}
        {props.cardData.gym_phone_number}
      </p>
      <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
        <span className="font-semibold">Email : </span> {props.cardData.gym_email}
      </p>
      <Link
        to={props.cardData.gym_id + "/members"}
